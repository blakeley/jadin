        ...
        if (firstByte == 0xff) {
            ...
            switch (subtypeByte) {
                ...
                case 0x20:
                    ...
                    if (length_1 != 1)
                        throw ("Length for this midiChannelPrefix event was " +
                            length_1 +
                            ", but must be 1");
                    return event;
                case 0x21:
                ...
                case 0x2f:
                    ...
                    if (length_1 != 0)
                        throw ("Length for this endOfTrack event was " +
                            length_1 +
                            ", but must be 0");
                    return event;
                case 0x51:
                ...
                case 0x54:
                    ...
                    if (length_1 != 5)
                        throw ("Length for this smpteOffset event was " +
                            length_1 +
                            ", but must be 5");
                ...
                case 0x58:
                    ...
                    if (length_1 != 4)
                        throw ("Length for this timeSignature event was " +
                            length_1 +
                            ", but must be 4");
                ...
                case 0x59:
                    ...
                    if (length_1 != 2)
                        throw ("Length for this keySignature event was " +
                            length_1 +
                            ", but must be 2");
