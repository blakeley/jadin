    ...
    if (firstByte == 0xff) {
      ...
      switch (subtypeByte) {
        ...
        case 0x20:
          ...
          if (length != 1)
            throw (
              "Length for this midiChannelPrefix event was " +
              length +
              ", but must be 1"
            );
          return event;
        case 0x21:
          ...
          if (length != 1)
            throw (
              "Length for this port event was " + length + ", but must be 1"
            );
          return event;
        case 0x2f:
        ...
        case 0x54:
          ...
          if (length != 5)
            throw (
              "Length for this smpteOffset event was " +
              length +
              ", but must be 5"
            );
          const hourByte = this.readInt(1);
          event.frameRate = ({ 0: 24, 1: 25, 2: 29.97, 3: 30 } as any)[
            hourByte >> 6
          ];
        ...
        case 0x58:
          ...
          if (length != 4)
            throw (
              "Length for this timeSignature event was " +
              length +
              ", but must be 4"
            );
        ...
        case 0x59:
          ...
          if (length != 2)
            throw (
              "Length for this keySignature event was " +
              length +
              ", but must be 2"
            );
